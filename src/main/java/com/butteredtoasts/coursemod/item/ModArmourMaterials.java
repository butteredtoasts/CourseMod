...
public class ModArmourMaterials {
    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS = DeferredRegister.create(Registries.ARMOR_MATERIAL, CourseMod.MODID);
    ...
    public static final Holder<ArmorMaterial> BLACK_OPAL =
            ARMOR_MATERIALS.register("black_opal", () -> new ArmorMaterial(
                    ...
                    List.of(new ArmorMaterial.Layer(ResourceLocation.fromNamespaceAndPath(CourseMod.MODID, "black_opal"))),
                    0, 0));
